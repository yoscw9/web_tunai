...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <a href="<?php echo e(route('orders.index')); ?>" class="text-muted fw-light">Daftar Pesanan</a> / Detail Pesanan
        </h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a href="<?php echo e(route('orders.print', ['id' => $orders->id])); ?>" target="_blank"
                            class="btn btn-primary">Print Nota</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/pages/orders/show.blade.php ENDPATH**/ ?>