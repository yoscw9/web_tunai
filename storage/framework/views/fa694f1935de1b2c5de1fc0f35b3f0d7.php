            ...
            <div class="card-datatable table-responsive">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons">
                                <a href="<?php echo e(route('rempeyek.create')); ?>" class="dt-button create-new btn btn-primary"
                                    type="button">
                                    <span>
                    ...
                    <table class="datatables-basic table border-top dataTable no-footer dtr-column mb-2">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $rempeyek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($loop->odd ? 'odd' : 'even'); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('rempeyek.edit', $item)); ?>" class="btn btn-sm btn-warning" hint="Edit Menu"><i
                                                class="bx bxs-edit"></i></a>
                                        <button @click="axiosDelete('<?php echo e(route('rempeyek.destroy', $item)); ?>')"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/admin/pages/menus/rempeyek.blade.php ENDPATH**/ ?>