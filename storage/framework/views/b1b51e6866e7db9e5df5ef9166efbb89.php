...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Daftar </span>Minuman
        </h4>
                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons">
                                <a href="<?php echo e(route('minuman.create')); ?>" class="dt-button create-new btn btn-primary"
                                    type="button">
                                    <span>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $minuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($loop->odd ? 'odd' : 'even'); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('minuman.edit', $item)); ?>" class="btn btn-sm btn-warning"
                                            hint="Edit Menu"><i class="bx bxs-edit"></i></a>
                                        <button @click="axiosDelete('<?php echo e(route('minuman.destroy', $item)); ?>')"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/admin/pages/menus/minuman.blade.php ENDPATH**/ ?>