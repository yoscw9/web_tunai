                ...
                <?php $__currentLoopData = $form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row mb-3">
                        ...
                        <?php switch($input['type']):
                            case ('select'): ?>
                                <select name="<?php echo e($input['name']); ?>" class="form-control">
                                    <?php $__currentLoopData = $input['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>" <?php echo e($input['value'] == $id ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                            ...
                            <?php break; ?>
                            <?php default: ?>
                            <input type="<?php echo e($input['type']); ?>" name="<?php echo e($input['name']); ?>" class="form-control" placeholder="<?php echo e($input['placeholder']); ?>" value="<?php echo e(isset($input['value']) ? $input['value'] : old($input['name'])); ?>" autocomplete="off" />
                        <?php endswitch; ?>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/admin/forms/edit.blade.php ENDPATH**/ ?>