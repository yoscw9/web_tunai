                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="date" class="form-control" name="from_date" id="from_date"
                                    value="<?php echo e(request('from_date') == null ? $before->format('Y-m-d') : request('from_date')); ?>" />
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Sampai Tanggal</label>
                                <input type="date" class="form-control" name="to_date" id="to_date"
                                    value="<?php echo e(request('to_date') == null ? $now->format('Y-m-d') : request('to_date')); ?>" />
                            </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="<?php echo e($loop->odd ? 'odd' : 'even'); ?>">
                                <td><a href="<?php echo e(route('orders.show', $item)); ?>"><?php echo e($item->order_code); ?></a></td>
                        ...
                        <tr>
                            ...
                            <td><b><?php echo e(Formatter::moneyFormat($orders->sum('total_amount'))); ?></b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/pages/reports.blade.php ENDPATH**/ ?>