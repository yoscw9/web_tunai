...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Daftar </span>Paket
        </h4>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($loop->odd ? 'odd' : 'even'); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('packages.detail', $item)); ?>" class="btn btn-sm btn-info"
                                            hint="Edit Paket"><i class="bx bxs-edit"></i></a>
                                        <a href="<?php echo e(route('packages.edit', $item)); ?>" class="btn btn-sm btn-warning"
                                            hint="Edit Paket"><i class="bx bxs-edit"></i></a>
                                        <button @click="axiosDelete('<?php echo e(route('packages.destroy', $item)); ?>')"
                                            class="btn btn-sm btn-danger"><i class="bx bxs-trash"
                                                hint="Hapus Paket"></i></button>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tunai_app\resources\views/admin/pages/packages.blade.php ENDPATH**/ ?>