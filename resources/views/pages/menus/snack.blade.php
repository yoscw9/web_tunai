                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons">
                                <a href="{{ route('snack.create') }}" class="dt-button create-new btn btn-primary"
                                    type="button">
                                    <span>
                        ...
                        <tbody>
                            @foreach ($snack as $item)
                                <tr class="{{ $loop->odd ? 'odd' : 'even' }}">
                                    ...
                                    <td>
                                        <a href="{{ route('snack.edit', $item) }}" class="btn btn-sm btn-warning" hint="Edit Menu"><i
                                                class="bx bxs-edit"></i></a>
                                        <button @click="axiosDelete('{{ route('snack.destroy', $item) }}')"
